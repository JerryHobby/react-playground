...
const { onFavorite } = this.props;
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="crimson" class="bi bi-suit-heart-fill" viewBox="0 0 16 16"
    ...
    return(
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="grey" class="bi bi-suit-heart" viewBox="0 0 16 16"       onClick={() => this.props.onFavorite(movie)}>
